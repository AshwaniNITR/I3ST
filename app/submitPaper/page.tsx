        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="mb-16 text-center animate-fadeIn">
            ...
            <p className="text-gray-600 font-extrabold text-lg max-w-3xl mx-auto">
              Important guidelines and policies for paper submission and publication
            </p>
          </div>
          ...
          <div className="max-w-5xl mx-auto bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 lg:p-12 border border-gray-200/50">
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-700 mb-6 leading-relaxed">
                Prospective authors are invited to submit a <span className="font-semibold text-blue-700">FULL PAPER (4–6 pages)</span> through the 
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-500 p-5 rounded-r">
                <p className="text-gray-800 italic">
                  By submitting a paper, authors indicate their willingness to register for and present the work at the Conference if accepted.
                </p>
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                However, IEEE reserves the right to exclude a submission from distribution after the conference, 
                including exclusion from IEEE Xplore, if the submission does not meet IEEE standards for scope and/or quality.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 shadow-sm border border-gray-200">
                <h3 className="text-xl font-bold text-gray-800 mb-4">Template</h3>
                <p className="text-gray-700 mb-4">
                  Conference paper templates in multiple formats are available through the following link:
                </p>
                <a 
              ...
              {/* Revision Policy */}
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 shadow-sm border border-gray-200">
                <h3 className="text-xl font-bold text-gray-800 mb-4">Revision Policy</h3>
                <p className="text-gray-700">
                  If minor revisions are requested, acceptance is contingent upon satisfactorily addressing all reviewer comments in the final submission. 
                  Papers may still be rejected at the final stage if reviewer remarks are not properly addressed.
                </p>
              </div>
            </div>
            ...
            <div className="mt-12 p-6 bg-gradient-to-r from-red-50 to-orange-50 rounded-xl border border-red-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-bold text-gray-800 mb-2">Important Notes</h4>
