...
>
  ...
  <div className="p-4 sm:p-6">
    ...
    <div className="flex overflow-x-auto border-b border-blue-200 mb-6 -mx-4 px-4 sm:mx-0 sm:px-0">
      ...
      >
        <Plane className={`w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3 ${activeTab === "air" ? "text-blue-600" : "text-gray-500"}`} />
        By Air
      </button>
      <button
      ...
      >
        <Train className={`w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3 ${activeTab === "train" ? "text-blue-600" : "text-gray-500"}`} />
        By Train
      </button>
      <button
      ...
      >
        <Bus className={`w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3 ${activeTab === "local" ? "text-blue-600" : "text-gray-500"}`} />
        Local Transport
      </button>
    </div>
        ...
        <div className="grid gap-4 sm:gap-6">
          <div className="bg-gradient-to-br from-white to-blue-50 rounded-xl p-4 sm:p-6 shadow-md border border-blue-200 hover:shadow-lg transition-shadow">
            <div className="flex flex-col sm:flex-row sm:items-start mb-4">
              ...
              <div>
                <h3 className="font-bold text-lg sm:text-xl text-blue-900">Jharsuguda Airport (IXJ)</h3>
                <p className="text-blue-600 text-xs sm:text-sm font-medium">Closest airport - 84 km from NIT Rourkela</p>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-white to-blue-50 rounded-xl p-4 sm:p-6 shadow-md border border-blue-200 hover:shadow-lg transition-shadow">
            <div className="flex flex-col sm:flex-row sm:items-start mb-4">
              ...
              <div>
                <h3 className="font-bold text-lg sm:text-xl text-blue-900">Ranchi Airport (IXR)</h3>
                <p className="text-blue-600 text-xs sm:text-sm font-medium">180 km from NIT Rourkela</p>
              </div>
            </div>
            <ul className="space-y-3 sm:pl-16">
              <li className="flex items-start">
          ...
          <div className="bg-gradient-to-br from-white to-blue-50 rounded-xl p-4 sm:p-6 shadow-md border border-blue-200 hover:shadow-lg transition-shadow">
            <div className="flex flex-col sm:flex-row sm:items-start mb-4">
              ...
              <div>
                <h3 className="font-bold text-lg sm:text-xl text-blue-900">Bhubaneswar Airport (BBI)</h3>
                <p className="text-blue-600 text-xs sm:text-sm font-medium">340 km from NIT Rourkela</p>
              </div>
            </div>
            <ul className="space-y-3 sm:pl-16">
              <li className="flex items-start">
      ...
      >
        <div className="bg-gradient-to-br from-white to-blue-50 rounded-xl p-4 sm:p-6 shadow-md border border-blue-200 mb-6">
          <div className="flex flex-col sm:flex-row sm:items-start mb-6">
            ...
            <div>
              <h3 className="font-bold text-lg sm:text-xl text-blue-900">Rourkela Railway Station (ROU)</h3>
              <p className="text-blue-600 text-xs sm:text-sm font-medium">Main station - 7 km from NIT Rourkela campus</p>
            </div>
          </div>

          <div className="mb-6">
            <h4 className="font-bold text-base sm:text-lg text-blue-900 mb-4">Major Train Connectivity:</h4>
            <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
              {[
                ...
                <div key={idx} className="bg-white p-3 sm:p-4 rounded-lg border border-blue-200 shadow-sm">
                  <p className="font-semibold text-blue-900 mb-2 text-sm sm:text-base">From {route.from}:</p>
                  <ul className="space-y-1">
                    {route.trains.map((train, trainIdx) => (
                      <li key={trainIdx} className="flex items-start text-xs sm:text-sm text-gray-700">
          ...
          <div>
            <h4 className="font-bold text-base sm:text-lg text-blue-900 mb-4">From Station to Campus:</h4>
            <div className="grid sm:grid-cols-3 gap-3 sm:gap-4">
              <div className="bg-gradient-to-br from-white to-blue-50 p-3 sm:p-4 rounded-lg border border-blue-200">
                <div className="flex items-center mb-2">
                  ...
                  <span className="font-semibold text-blue-900 text-sm sm:text-base">Auto-rickshaws</span>
                </div>
                <p className="text-xs sm:text-sm text-gray-700">Available outside the station</p>
                <p className="text-blue-600 font-medium text-sm sm:text-base">₹150-200</p>
              </div>
              <div className="bg-gradient-to-br from-white to-blue-50 p-3 sm:p-4 rounded-lg border border-blue-200">
                <div className="flex items-center mb-2">
                  <Car className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 mr-2" />
                  <span className="font-semibold text-blue-900 text-sm sm:text-base">Taxis</span>
                </div>
                <p className="text-xs sm:text-sm text-gray-700">Pre-paid taxis available</p>
                <p className="text-blue-600 font-medium text-sm sm:text-base">₹250-300</p>
              </div>
              <div className="bg-gradient-to-br from-white to-blue-50 p-3 sm:p-4 rounded-lg border border-blue-200">
                <div className="flex items-center mb-2">
                  <Bus className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 mr-2" />
                  <span className="font-semibold text-blue-900 text-sm sm:text-base">City Bus</span>
                </div>
                <p className="text-xs sm:text-sm text-gray-700">Bus no. 4 to NIT campus</p>
                <p className="text-blue-600 font-medium text-sm sm:text-base">₹15-20</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 sm:p-5 rounded-xl border border-blue-300">
          <div className="flex items-start">
            ...
            <div>
              <h4 className="font-bold text-base sm:text-lg text-blue-900 mb-2">Pro Tip:</h4>
    ...
    {activeTab === "local" && (
      ...
      >
        <div className="grid gap-4 sm:gap-6">
          <div className="bg-gradient-to-br from-white to-blue-50 rounded-xl p-4 sm:p-6 shadow-md border border-blue-200">
            <div className="flex flex-col sm:flex-row sm:items-start mb-6">
              ...
              <div>
                <h3 className="font-bold text-lg sm:text-xl text-blue-900">From Rourkela Station to Campus</h3>
              </div>
            </div>
                ...
                <div key={idx} className="flex items-start p-3 rounded-lg bg-white border border-blue-100">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                      <h4 className="font-semibold text-blue-900 text-sm sm:text-base">{option.title}</h4>
                    ...
                    <p className="text-xs sm:text-sm text-gray-600 mt-1">{option.time} • {option.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-gradient-to-br from-white to-blue-50 rounded-xl p-4 sm:p-6 shadow-md border border-blue-200">
            <div className="flex flex-col sm:flex-row sm:items-start mb-6">
              ...
              <div>
                <h3 className="font-bold text-lg sm:text-xl text-blue-900">Within Rourkela City</h3>
              </div>
            </div>
            <div className="space-y-3 sm:space-y-4">
              {[
                ...
                <div key={idx} className="flex items-start p-3 rounded-lg bg-white border border-blue-100">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900 text-sm sm:text-base">{option.title}</h4>
                    <p className="text-xs sm:text-sm text-gray-600 mt-1">{option.desc}</p>
        ...
        <div className="mt-4 sm:mt-6 bg-gradient-to-r from-yellow-50 to-yellow-100 p-4 sm:p-5 rounded-xl border border-yellow-200">
          <div className="flex items-start">
            <MapPin className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-600 mr-3 sm:mr-4 flex-shrink-0" />
            <div>
              <h4 className="font-bold text-base sm:text-lg text-yellow-800 mb-2">Campus Entry Information</h4>
